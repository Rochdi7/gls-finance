...
Route::controller(JobickAdminController::class)->group(function () {
    Route::get('/', 'dashboard');
    Route::get('/index', 'dashboard')->name('dashboard');
    Route::get('/index-2','dashboard_2')->name('dashboard_2');
    Route::get('/jobs-page','jobs_page')->name('jobs_page');
	Route::get('/application-page', 'application_page')->name('application_page');
    Route::get('/my-profile', 'my_profile')->name('my_profile');
	Route::get('/statistics-page', 'statistics_page')->name('statistics_page');
	Route::get('/companies', 'companies')->name('companies');
	Route::get('/job-list', 'job_list')->name('job_list');
	Route::get('/job-view', 'job_view')->name('job_view');
    Route::get('/job-application', 'job_application')->name('job_application');
    Route::get('/apply-job', 'apply_job')->name('apply_job');
    Route::get('/new-job', 'new_job')->name('new_job');
    Route::get('/user-profile', 'user_profile')->name('user');
