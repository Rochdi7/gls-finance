        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-secondary">Sent message <span class="btn-icon-end"><i
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-block">
                    ...
                    <p class="mb-0 subtitle">add <code>.btn-facebook, .btn-twitter, .btn-youtube...</code> to change
                        the style</p>
                </div>
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-pinterest">Pinterest <span class="btn-icon-end"><i
                                class="fab fa-pinterest-square"></i></span>
                    </button>
