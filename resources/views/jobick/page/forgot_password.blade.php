...
<head>
    ...
    <meta name="twitter:description"
        content="We proudly present Jobick, a Job Admin dashboard HTML Template, If you are hiring a job expert you would like to build a superb website for your Jobick, it's a best choice.">
    <meta name="twitter:image" content="https://jobick.GLS Team.com/xhtml/social-image.png">
                    ...
                    <div class="card mb-0 h-auto">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a href="{{ url('index') }}"><img class="logo-auth"
                                        src="{{ asset('images/logo-full.png') }}" alt=""></a>
                            </div>
