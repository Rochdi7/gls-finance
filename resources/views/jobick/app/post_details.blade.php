                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-news">
                                <h5 class="card-title">Our Latest News</h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="post-details">
                        <h3 class="mb-2 text-dark">Collection of textile samples lay spread</h3>
                        ...
                        <div class="comment-respond" id="respond">
                            <h4 class="card-title mb-4" id="reply-title">Leave a Reply </h4>
                            <form class="comment-form" id="commentform" method="post">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="author" class="text-black font-w600 form-label">Name <span
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="email" class="text-black font-w600 form-label">Email <span
                                                    class="required">*</span></label>
