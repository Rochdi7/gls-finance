                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-blog">
                                <h5 class="card-title mb-0">Today Highlights</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-interest">
                                <h5 class="card-title mb-0">Interest</h5>
                                <div class="row mt-4 sp4" id="lightgallery">
                                    <a href="{{ asset('images/profile/2.jpg') }}" data-exthumbimage="{{ asset('images/profile/2.jpg') }}"
                                        data-src="{{ asset('images/profile/2.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    ...
                                    <a href="{{ asset('images/profile/3.jpg') }}" data-exthumbimage="{{ asset('images/profile/3.jpg') }}"
                                        data-src="{{ asset('images/profile/3.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    ...
                                    <a href="{{ asset('images/profile/4.jpg') }}" data-exthumbimage="{{ asset('images/profile/4.jpg') }}"
                                        data-src="{{ asset('images/profile/4.jpg') }}" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-news">
                                <h5 class="card-title mb-0">Our Latest News</h5>
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/5.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-dark">Innovations
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/6.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-dark">Getting More
                                                for Your Money</a></h5>
                                        <p class="mb-0">I shared this on my fb wall a few months back, and I thought.
                                        </p>
                                    </div>
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/7.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-dark">Your
                                                Ultimate Guide to Event Tickets</a></h5>
                                        <p class="mb-0">I shared this on my fb wall a few months back, and I thought.
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                <div class="post-input">
                                                    <textarea name="textarea" id="textarea" cols="30" rows="8" class="form-control bg-transparent"
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="{{ url('post-details') }}">
                                                        <h3 class="text-dark">Navigating the World of Live
                                                            Entertainment</h3>
                                                    </a>
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="{{ asset('images/profile/9.jpg') }}" alt=""
                                                        class="img-fluid w-100 rounded">
                                                    <a class="post-title" href="{{ url('post-details') }}">
                                                        <h3 class="text-dark">How to Score the Best Seats in the House
                                                        </h3>
                                                    </a>
                                                    <p>A wonderful serenity has take possession of my entire soul like
                                                        these sweet morning of spare which enjoy whole heart.A wonderful
                                                ...
                                                <div class="profile-uoloaded-post pb-3">
                                                    <img src="{{ asset('images/profile/8.jpg') }}" alt=""
                                                        class="img-fluid w-100 rounded">
                                                    <a class="post-title" href="{{ url('post-details') }}">
                                                        <h3 class="text-black">Stories from the World of Events</h3>
                                                    </a>
                                                    <p>A wonderful serenity has take possession of my entire soul like
                                                        these sweet morning of spare which enjoy whole heart.A wonderful
                                                        serenity has take possession of my entire soul like these sweet
