    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-4 ">
                            <!-- Tab panes -->
                            ...
                            <nav>
                                <div class="product-detail-tab nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-first-tab" data-bs-toggle="tab"
                                        ...
                                        <img class="img-fluid  rounded" src="{{ asset('images/tab/1.jpg') }}" alt=""
                                            width="100">
                                    </button>
                                    <button class="nav-link" id="nav-second-tab" data-bs-toggle="tab"
                                        ...
                                        <img class="img-fluid  rounded" src="{{ asset('images/tab/2.jpg') }}" alt=""
                                            width="100">
                                    </button>
                                    <button class="nav-link" id="nav-third-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-third" type="button" role="tab"
                                        aria-controls="nav-third" aria-selected="false">
                                        <img class="img-fluid  rounded" src="{{ asset('images/tab/3.jpg') }}" alt=""
                                            width="100">
                                    </button>
                                    <button class="nav-link" id="nav-for-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-for" type="button" role="tab" aria-controls="nav-for"
                                        aria-selected="false">
                                        <img class="img-fluid  rounded" src="{{ asset('images/tab/4.jpg') }}" alt=""
                                            width="100">
                                    </button>
                                </div>
                            </nav>
                        ...
                        <!--Tab slider End-->
                        <div class="col-xl-9 col-lg-6  col-md-6 col-xxl-6 col-sm-12">
                            <div class="product-detail-content">
                                ...
                                <div class="new-arrival-content pr">
                                    ...
                                    <p>Product tags:&nbsp;&nbsp;
                                        <span class="badge badge-info light">bags</span>
                                        <span class="badge badge-danger light">clothes</span>
                                        <span class="badge badge-primary light">shoes</span>
                                    ...
                                    <div class="d-flex align-items-end flex-wrap mt-4">
                                        ...
                                        <div class="filtaring-area me-3">
                                            <div class="size-filter">
                                                ...
                                                <div class="d-flex select-size mb-2" role="group"
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="text-center mb-4">
                                <img class="img-fluid rounded" width="78" src="{{ asset('images/avatar/1.jpg') }}"
                                    alt="DexignZone">
                            </div>
                            <div class="mb-3">
        ...
        <div>
            <h4 class="card-title mb-3">Similar Products</h4>
