    ...
    <a href="javascript:void(0)" class="btn btn-primary btn-rounded">Search<i class="flaticon-381-search-2 ms-2"></i></a>
            ...
            <div class="input-group search-box">
                ...
                <a href="javascript:void(0)" class="btn btn-primary btn-rounded">Search<i
                        class="flaticon-381-search-2 ms-2 d-inline-block"></i></a>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="Boxed" role="tabpanel">
                            ...
                            <div class="card jobs2">
                                <div class="card-body">
                                                ...
                                                <g transform="translate(-457 -443)">
                                                    ...
                                                    <g transform="translate(457 443)">
                                                        ...
                                                        <circle data-name="Ellipse 12" cx="18" cy="18"
                                                            r="18" transform="translate(15 20)" fill="#fff"></circle>
                                    ...
                                    <div class="bottom-info pt-1">
                                        <p class="mb-0"><i class="fas fa-map-marker-alt me-2"></i>Manchester, England
                                        </p>
                                        <p class="mb-0"><i class="fas fa-comments-dollar me-2"></i>$ 2,000 - $ 2,500
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-xxl-4  col-md-4 col-sm-6">
                            <div class="card jobs2">
                                <div class=" card-body">
                                                ...
                                                <g transform="translate(-0.332)">
                                                    ...
                                                    <g transform="translate(0.332)">
                                                        ...
                                                        <ellipse data-name="Ellipse 12" cx="17.987" cy="18"
                                                            rx="17.987" ry="18"
                                                            transform="translate(15.147 20)" fill="#fff" />
                                                        <ellipse data-name="Ellipse 11" cx="10.887" cy="11"
                                                            rx="10.887" ry="11"
                                                            transform="translate(35.973 15)" fill="#ffe70c"
                                                            style="mix-blend-mode: multiply;isolation: isolate" />
                                                    </g>
                                                </g>
                                            </svg>
                                    ...
                                    <div class="bottom-info pt-1">
                                        <p class="mb-0"><i class="fas fa-map-marker-alt me-2"></i>Manchester,
                                            England</p>
                                        <p class="mb-0"><i class="fas fa-comments-dollar me-2"></i>$ 2,000 - $ 2,500
                                        </p>
                                    </div>
                                                ...
                                                <g transform="translate(0.093)">
                                                    ...
                                                    <g transform="translate(-0.093)">
                                                        ...
                                                        <ellipse data-name="Ellipse 12" cx="17.75" cy="18"
                                                            rx="17.75" ry="18"
                                                            transform="translate(14.947 20)" fill="#fff" />
                                                ...
                                                <g transform="translate(-0.483)">
                                                    ...
                                                    <g transform="translate(0.483)">
                                                        ...
                                                        <ellipse data-name="Ellipse 12" cx="18.46" cy="18"
                                                            rx="18.46" ry="18"
                                                            transform="translate(14.2 20)" fill="#fff" />
                                                        <ellipse data-name="Ellipse 11" cx="10.887" cy="11"
                                                            rx="10.887" ry="11"
                                                            transform="translate(35.973 15)" fill="#ffe70c"
                                                            style="mix-blend-mode: multiply;isolation: isolate" />
                                                ...
                                                <g transform="translate(0.362)">
                                                    ...
                                                    <g transform="translate(-0.362)">
                                                        ...
                                                        <ellipse data-name="Ellipse 11" cx="10.743" cy="11"
                                                            rx="10.743" ry="11"
                                                            transform="translate(36.434 15)" fill="#ffe70c"
                                                            style="mix-blend-mode: multiply;isolation: isolate" />
                                                    </g>
                                                </g>
                                            </svg>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div class="mb-sm-0 mb-3">
                            <p class="mb-0 text-dark">Showing 5 of 102 Data</p>
                        </div>
                        <nav>
                ...
                <div class="tab-pane fade" id="List1">
                    <div class="row">
                        <div class="col-xl-12">
                            <div
                                class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                                    <div class="icon-img-bx me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54"
                                            viewBox="0 0 71 71">
                                            <g transform="translate(0.243)">
                                                <rect width="71" height="71" rx="12"
                                                    transform="translate(-0.243)" fill="#c5c5c5" />
                                                <g transform="translate(-0.243)">
                                                    <rect data-name="placeholder" width="71" height="71"
                                                        rx="12" fill="#2769ee" />
                                                    <ellipse data-name="Ellipse 12" cx="17.75" cy="18"
                                    ...
                                    <div>
                                        <h2 class="title"><a href="javascript:void(0);"
                                                class="text-dark">Programmer</a></h2>
                                        <span class="text-primary fs-13">Highspeed Studios</span>
                                    </div>
                                </div>
                                <div class="d-flex  col-lg-3 col-sm-6 align-items-center  mb-lg-0 mb-3">
                                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="54" height="54" rx="12" fill="#2BC155"></rect>
                                    ...
                                    <div>
                                        <h6 class="sub-title mb-1">$14,000 - $25,000</h6>
                                        <span>Monthly Salary</span>
                                    </div>
                                </div>
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center">
                                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="54" height="54" rx="12" fill="#FBA556"></rect>
                                        <path
                                    ...
                                    <div>
                                        <h6 class="sub-title mb-1">London, England</h6>
                                        <span>Location</span>
                                    </div>
                                </div>
                                <div class="text-lg-end text-start col-lg-2 col-sm-6 mt-sm-0 mt-2">
                                    <a href="javascript:void(0);"
                                        class="btn btn-sm btn-outline-primary rounded me-2">Apply Now</a>
                                </div>
                            </div>
                            <div
                                class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                                ...
                                <div class="d-flex  col-lg-3 col-sm-6 align-items-center  mb-lg-0 mb-3">
                                    ...
                                    <div>
                                        <h6 class="sub-title mb-1">$6,000 - $6,500</h6>
                                        <span>Monthly Salary</span>
                                    </div>
                                </div>
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center">
                                ...
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                                    <div class="icon-img-bx me-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54"
                                            ...
                                            <g transform="translate(0.243)">
                                                <rect width="71" height="71" rx="12"
                                                    transform="translate(-0.243)" fill="#ee27c0"></rect>
                                                <g transform="translate(-0.243)">
                                                    <rect data-name="placeholder" width="71" height="71"
                            ...
                            <div
                                ...
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                                    ...
                                    <div>
                                        <h2 class="title"><a href="javascript:void(0);" class="text-dark">Graphic
                                                Designer</a></h2>
                                        <span class="text-primary fs-13">Bubbles Studios</span>
                                    </div>
                                </div>
                                <div class="d-flex  col-lg-3 col-sm-6 align-items-center  mb-lg-0 mb-3">
                                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54"
                                    ...
                                    <div>
                                        <h6 class="sub-title mb-1">$2,000 - $2,500</h6>
                                        <span>Monthly Salary</span>
                                    </div>
                                </div>
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center">
                            ...
                            <div
                                ...
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                                    ...
                                    <div>
                                        <h2 class="title"><a href="javascript:void(0);" class="text-dark">Data
                                                Scientist</a></h2>
                                        <span class="text-primary fs-13">Kleon Studios</span>
                                    </div>
                                </div>
                                <div class="d-flex  col-lg-3 col-sm-6 align-items-center  mb-lg-0 mb-3">
                                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="54" height="54" rx="12" fill="#2BC155">
                                        </rect>
                                        <g clip-path="url(#clip6)">
                                            <path
                                                d="M27.0001 19.84C23.5987 19.84 20.6536 22.2024 19.9157 25.5229L17.4992 36.397C17.4815 36.4768 17.4725 36.5583 17.4725 36.64C17.4725 37.2585 17.974 37.76 18.5925 37.76H35.4077C35.4894 37.76 35.5709 37.751 35.6507 37.7333C36.2545 37.5991 36.6352 37.0008 36.501 36.397L34.0846 25.5229C33.3467 22.2024 30.4016 19.84 27.0001 19.84ZM27.0001 17.6C31.4515 17.6 35.3056 20.6916 36.2712 25.037L38.6877 35.9111C39.0902 37.7226 37.9481 39.5174 36.1366 39.92C35.8973 39.9731 35.6529 40 35.4077 40H18.5925C16.7369 40 15.2325 38.4956 15.2325 36.64C15.2325 36.3948 15.2594 36.1504 15.3126 35.9111L17.729 25.037C18.6947 20.6916 22.5488 17.6 27.0001 17.6Z"
                                ...
                                <div class="d-flex col-lg-3 col-sm-6 align-items-center">
                                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="54" height="54" rx="12" fill="#FBA556">
                                        </rect>
                                        <path
                                            d="M27 15C21.934 15 17.8125 19.1215 17.8125 24.1875C17.8125 25.8091 18.2409 27.4034 19.0515 28.7979C19.2404 29.123 19.4516 29.4398 19.6793 29.7396L26.6008 39H27.3991L34.3207 29.7397C34.5483 29.4398 34.7595 29.1231 34.9485 28.7979C35.7591 27.4034 36.1875 25.8091 36.1875 24.1875C36.1875 19.1215 32.066 15 27 15ZM27 27.2344C25.32 27.2344 23.9531 25.8675 23.9531 24.1875C23.9531 22.5075 25.32 21.1406 27 21.1406C28.68 21.1406 30.0469 22.5075 30.0469 24.1875C30.0469 25.8675 28.68 27.2344 27 27.2344Z"
                                            fill="white"></path>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <span class="text-center d-block block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="141" height="141"
                                    ...
                                    <g transform="translate(8.243 8)">
                                        <g transform="translate(-0.243)" fill="#c5c5c5" stroke="var(--card)"
                                            stroke-width="8">
                                            <rect width="125" height="125" rx="12" stroke="none" />
                                            <rect x="-4" y="-4" width="133" height="133" rx="16"
                                                fill="none" />
                                        </g>
                                        <g transform="translate(-0.243)">
                                            <rect data-name="placeholder" width="125" height="125"
                                                rx="12" fill="#2769ee" />
                                            <ellipse data-name="Ellipse 12" cx="31.25" cy="31.69"
                                                rx="31.25" ry="31.69" transform="translate(26.316 35.211)"
                                                fill="#fff" />
                                            <ellipse data-name="Ellipse 11" cx="18.914" cy="19.366"
                                                rx="18.914" ry="19.366" transform="translate(64.145 26.408)"
                                                fill="#ffe70c"
                                                style="mix-blend-mode: multiply;isolation: isolate" />
                                        </g>
                                    </g>
                            ...
                            <h4 class="mb-1 mt-2 text-center">UX Researcher</h4>
                            ...
                            <div>
                                <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Tempor
                                    incididunt ut labore </span>
                                <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Lorem ipsum
                                    dolor </span>
                                <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Sit amet
                                    consectetur </span>
                                <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Labore
                                    adipsicans elit do uasde </span>
                            </div>
                            <div class="location">
                        ...
                        <div class="card-footer border-0 pt-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="javascript:void(0);" class="btn btn-secondary  btn-sm btn-rounded light"><i
