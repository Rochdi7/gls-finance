        ...
        <div class="col-xl-12">
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="listline-wrapper mb-3 pt-2">
                                <div class="item">
                            ...
                            <p class="mb-0">A data analyst collects, interprets and visualizes data to uncover
                                insights. A data analyst assigns a numerical value to business functions so performance
                                is assessed and compared over time. </p>
                        </div>
                        <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <span><i class="fas fa-edit me-2 text-primary"></i>Posted by</span>
                                <p class="mb-0 text-black font-w500 mt-1">16-02-2023, 15:15 PM</p>
                            </div>
                            <div class="mt-sm-0 mt-3">
                                <span class="me-2"><i class="fas fa-user-tie me-2 text-primary"></i>HR/Admin</span>
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm apply-job"><i
                                        class="far fa-check-circle me-2"></i>Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">HR Administrator</h4>
                            <div class="listline-wrapper mb-3 pt-2">
                                <div class="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="20px" height="20px" viewBox="0 0 24 24" version="1.1"
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <span><i class="fas fa-edit text-primary me-2"></i>Posted by</span>
                                <p class="mb-0 text-black font-w500 mt-1">16-02-2023, 15:15 PM</p>
                            </div>
                            <div class="mt-sm-0 mt-3">
                                <span class="me-2"><i class="fas fa-user-tie text-primary me-2"></i>HR/Admin</span>
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm apply-job"><i
                                        class="far fa-check-circle me-2"></i>Apply Now</a>
                            </div>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Computer programmer</h4>
                            <div class="listline-wrapper mb-3 pt-2">
                                <div class="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="20px" height="20px" viewBox="0 0 24 24" version="1.1"
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Quality assurance tester</h4>
                            <div class="listline-wrapper mb-3 pt-2">
                                <div class="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="20px" height="20px" viewBox="0 0 24 24" version="1.1"
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">IT technician</h4>
                            <div class="listline-wrapper mb-3 pt-2">
                                <div class="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="20px" height="20px" viewBox="0 0 24 24" version="1.1"
