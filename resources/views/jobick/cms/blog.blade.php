        ...
        <div class="col-xl-12">
            ...
            <div class="mb-4 pb-3">
                <ul class="d-flex align-items-center flex-wrap">
                    ...
                    <li><a href="{{ url('blog-category') }}" class="btn btn-primary btn-sm mt-sm-0 mt-1">Add Blog Category</a>
                    </li>
                </ul>
            </div>
            <div class="filter cm-content-box box-primary">
                    ...
                    <div class="card-body pb-4">
                        <div class="table-responsive">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <p class="mb-2 me-3">Page 1 of 5, showing 2 records out of 8 total, starting on record
                                    1, ending on 2</p>
