                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 also supports multi-value select boxes. The select below is declared with the
                            multiple <code>attribute</code>.</p>
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <select class="js-example-disabled-multi" style="width:100%;" name="states[]"
                            multiple="multiple">
                            <option value="AL">Alabama</option>
                            <option value="WY">Wyoming</option>
                        </select>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <label class="form-label" for="id_label_single">Click this to highlight the single select
                            element</label>

                        <select class="select2-with-label-single js-states d-block" style="width:100%;"
                            id="id_label_single">
                            <option value="AL">Alabama</option>
                            <option value="WY">Wyoming</option>
                        </select>
                    ...
                    <div>
                        <label class="form-label" for="id_label_multiple">Click this to highlight the multiple select
                            element </label>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="">
                        <select class="js-example-theme-multiple" style="width:100%;" name="states[]"
                            multiple="multiple">
                            <option value="AL">Alabama</option>
                            <option value="WY">Wyoming</option>
                        </select>
