            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="slider-disabled ">
                        ...
                        <label>
                            <input class="form-check-input ms-2" type="checkbox" id="checkbox1">
                            Disable slider
                        </label>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="slider-update ">
                        ...
                        <button class="update-button btn btn-info btn-sm mb-2" id="update-1">Set range [20,
                            50]</button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="locked-slider">
                        ...
                        <button class="btn btn-info btn-sm mt-4" id="lockbutton"
