    ...
    <div class="row">
        <div class="col-xl-4 col-xxl-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body px-0">
                    <div id="DZ_W_TimeLine" class="widget-timeline dlab-scroll height370 px-4">
                        <ul class="timeline">
                            <li>
        ...
        <div class="col-xl-4 col-xxl-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body px-0">
                    <div id="DZ_W_TimeLine11" class="widget-timeline dlab-scroll style-1 height370 px-4">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-badge primary"></div>
                                <a class="timeline-panel text-muted" href="#">
        ...
        <div class="col-xl-4 col-xxl-6 col-lg-6">
            <div class="card border-0 pb-0">
                ...
                <div class="card-body px-0">
                    <div id="DZ_W_Todo3" class="widget-media dlab-scroll height370 px-4">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-panel">
                                    <div class="media me-2">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Alfie Mason <small class="text-muted">29 July 2020</small>
                                        </h5>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Jacob Tucker <small class="text-muted">29 July 2020</small>
                                        </h5>
                                        <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                        <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                        <a href="#" class="btn btn-outline-danger btn-xxs">Delete</a>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Jack Ronan <small class="text-muted">29 July 2020</small>
                                        </h5>
                                        <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                        <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                        <a href="#" class="btn btn-outline-danger btn-xxs">Delete</a>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Noah Baldon <small class="text-muted">29 July 2020</small>
                                        </h5>
                                        <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                        <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                        <a href="#" class="btn btn-outline-danger btn-xxs">Delete</a>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Thomas Grady <small class="text-muted">02:26 PM</small>
                                        </h5>
                                        <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                        <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                        <a href="#" class="btn btn-outline-danger btn-xxs">Delete</a>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">Oscar Weston <small class="text-muted">29 July 2020</small>
                                        </h5>
                                        <p class="mb-1">I shared this on my fb wall a few months back..</p>
                                        <a href="#" class="btn btn-primary btn-xxs shadow">Reply</a>
                                        <a href="#" class="btn btn-outline-danger btn-xxs">Delete</a>
        ...
        <div class="col-xl-4 col-xxl-6 col-lg-6">
            <div class="card border-0 pb-0">
                ...
                <div class="card-body px-0">
                    <div id="DZ_W_Todo4" class="widget-media dlab-scroll height370 px-4">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-panel">
            ...
            <div class="card active_users">
                ...
                <div class="card-body pt-0">
                    <div class="list-group-flush mt-4">
                        <div
                            class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 fw-semi-bold border-top-0 border-0 border-bottom">
        ...
        <div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
            <div class="card text-white bg-primary">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between text-white"><span
                            class="mb-0">Experience :</span><strong>2+ years</strong></li>
                    <li class="list-group-item d-flex justify-content-between text-white"><span
                            class="mb-0">Skills :</span><strong>Html, Css </strong></li>
                    <li class="list-group-item d-flex justify-content-between text-white"><span
                            class="mb-0">Salary :</span><strong>$2000</strong></li>
                    <li class="list-group-item d-flex justify-content-between text-white"><span
                            class="mb-0">Position :</span><strong>Web Designer</strong></li>
                    <li class="list-group-item d-flex justify-content-between text-white"><span
        ...
        <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
            <div class="card">
                <div class="card-body text-center ai-icon  text-primary">
                    ...
                    <a href="javascript:void();;" class="btn my-2 btn-primary btn-lg px-4"><i
                    ...
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            ...
                            <div class="clearfix text-center">
                                <h3 class="text-primary mb-0">4,500</h3>
                            </div>
                        </div>
                        <div class="card-body text-center">
                            <div class="ico-sparkline">
                ...
                <div class="col-xl-6 col-lg-6 col-xxl-6 col-md-6">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            ...
                            <div class="clearfix text-center">
                                <h3 class="text-danger mb-0">15,000</h3>
                                <span>Per Min</span>
                            </div>
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-xl-6 col-lg-6 col-xxl-6 col-md-6">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            ...
                            <div class="clearfix text-center">
                                <h3 class="text-success mb-0">50</h3>
        ...
        <div class="col-xl-6 col-xxl-8 col-lg-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card overflow-hidden ltr">
