...
<div class="row">
    ...
    <div class="col-xl-6 col-md-6 mb-4">
        <label class="form-label">Nom du centre<span class="text-danger scale5 ms-2">*</span></label>
    ...
    {{-- Ville --}}
    <div class="col-xl-6 col-md-6 mb-4">
        <label class="form-label">Ville<span class="text-danger scale5 ms-2">*</span></label>
        <input type="text" name="city" class="form-control @error('city') is-invalid @enderror"
            placeholder="Ville" aria-label="city" value="{{ $city }}" required>
        @error('city')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-xl-12">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input @error('active') is-invalid @enderror" type="radio" name="active"
                id="inlineRadio1" value="1" {{ $active === '1' ? 'checked' : '' }}>
            <label class="form-check-label" for="inlineRadio1">Actif</label>
        </div>

        <div class="form-check form-check-inline">
            <input class="form-check-input @error('active') is-invalid @enderror" type="radio" name="active"
                id="inlineRadio2" value="0" {{ $active === '0' ? 'checked' : '' }}>
