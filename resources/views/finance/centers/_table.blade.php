                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons d-flex justify-content-end">
                            ...
                            {{-- View (optional: for now links to edit to keep flow) --}}
                            <a href="{{ route('finance.centers.edit', $center) }}" class="btn btn-success light mr-2">
                            ...
                            {{-- Delete --}}
                            <form method="POST" action="{{ route('finance.centers.destroy', $center) }}" class="m-0 p-0">
                                @csrf
                                @method('DELETE')
